...
const Subject: React.FC<Route.ComponentProps> = ({ loaderData }) => {
  const [showAdd, setShowAdd] = useState(false);
  const [showEdit, setShowEdit] = useState<Tables<"subject">>();
  const [showDelete, setShowDelete] = useState<Tables<"subject">>();
  ...
  return (
    <div>
      <TopSection title="Mata Kuliah" onAdd={() => setShowAdd(true)} />
